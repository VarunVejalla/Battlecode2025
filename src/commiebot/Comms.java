...
public class Comms {
    ...
    // Goes through the world and updates important targets.
    ...
    public void describeWorldConcise() {
        ...
        for (int unbuiltRuin : unbuiltRuins) {
            ...
            System.out.print(getSectorCenter(unbuiltRuin) + " ");
        }
        ...
        for (int friendlyTower : friendlyTowers) {
            ...
            System.out.print(getSectorCenter(friendlyTower) + " ");
        }
        System.out.println(); System.out.println();
        ...
        for (int enemyTower : enemyTowers) {
            ...
            System.out.print(getSectorCenter(enemyTower) + " ");
        }
        System.out.println(); System.out.println();
    }
}
